...
if __name__ == '__main__':
    ...
    PATH_MODEL2 = './save_model/my_checkpoint3.h5'
    model2 = keras.models.load_model(PATH_MODEL2, custom_objects={"mdape": mdape,'loss_custom':loss_custom })
    ...
    for i in range(1,90):
        ...
        predict2 = model2.predict([np_air_i, np_meteo_i ])
        predict2 = np.squeeze(predict2, axis= 0)

        predict = predict * 0.4 + predict2 * 0.6
